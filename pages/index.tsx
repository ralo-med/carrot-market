  ...
  return (
    <div className="grid min-h-screen  gap-10 bg-slate-400 px-20 py-20 ">
      <div className="rounded-3xl bg-white p-6 shadow-xl">
        ...
        <button className="mx-auto mt-5 w-1/2 rounded-xl bg-blue-500 p-3 text-center text-white hover:bg-teal-500 focus:bg-red-500 active:bg-yellow-500">
          Checkout
        </button>
      </div>
      ...
      <div className="rounded-3xl bg-white p-6 shadow-xl">
        <div className="mb-5 flex items-center justify-between">
          ...
          <div className="space-x-3">
            <span>✭ 4.9</span>
            <span className="rounded p-2 shadow-xl">❤</span>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex items-center justify-between">
            <div className="space-x-2">
              <button className="h-5 w-5 rounded-full bg-yellow-500 ring-2  ring-offset-2"></button>
